...
vegsum <- create_diagnostic_veg(veg.dat2, su, minimportance = 0.5, covadj = .33, 
                                minconstancy = 55, noiseconstancy = 25,
                                minplots = 5,  use.ksi = TRUE, ksi = key.site.indicators, ksi.value = 1.2,
...
vegsum.pairs <- do_pairwise(veg.dat2, su2, minimportance = 0.5, minconstancy = 55, noiseconstancy = 10,
                            minplots = 5, 
                            covadj = .33, domcov = 10,
...
yy <- c("CWHds2_101a","CWHds2_101b" )
zz <- vegsum.pairs %>% filter(Unit1 %in% yy, Unit2 %in% yy)
...
dendro <- fviz_dend(dendro_hc, cex = .5, lwd = .5, h = .4,
        rect = TRUE,
         type = "rectangle",
          k_colors = "jco",
      rect_border = "black",
