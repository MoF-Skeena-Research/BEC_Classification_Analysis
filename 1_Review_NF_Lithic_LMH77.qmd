...
su <- dbReadTable(master_su, "Coast_Lithic_final_SU")
...
```{r report table}
#unit.choose <- c("Ro60.1", "Ro60.2", "Ro60!2.1", "Ro60!2.2",  "Ro61.1", "Ro61.2", "Ro62")
...
saveWorkbook(vegsum.wbk, "./vegsum.tables/LMH77_final_lithic_table.xlsx", overwrite = TRUE)
