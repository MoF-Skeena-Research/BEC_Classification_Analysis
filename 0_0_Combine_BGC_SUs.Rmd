...
all_SS <- left_join(all_SS, BGCs, by = c("bgc" = "BGC_NoSpace"))
...
DBQ=D:/BC_Correlation2_Vpro_2023/Zonal_SiteUnits.accdb;")
dbWriteTable(zonal_su, "All_zonals_SU", all_zonals, overwrite = TRUE, batch_rows = 1)
