...
require(DBI) #loads odbc as well
 becdb <- dbConnect(odbc::odbc(), .connection_string = "Driver={Microsoft Access Driver (*.mdb, *.accdb)}; DBQ=D:/OneDrive - Government of BC/BECdb_Working/BECdb_ver14_2026_v1.accdb;")
...
dbWriteTable(master_su, "All_BECv14_working_SU",  SU_all, overwrite = TRUE, batch_rows = 1, row.names = FALSE)
...
fwrite(SU_all, "./clean_tabs/All_BECv14_working_SU.csv")
