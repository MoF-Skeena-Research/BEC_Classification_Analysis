...
su_all <- sorts.LMH$SiteUnit %>% unique()
ss_v13 <- ssv13$SS_Label %>% unique()

# Find SUs in sorts.LMH that are missing from the v13 site-series table
missing_su <- setdiff(su_all, ss_v13) %>% as.data.frame()
missing_su

missing_ss <- setdiff(ss_v13, su_all) %>% as.data.frame()
missing_ss
