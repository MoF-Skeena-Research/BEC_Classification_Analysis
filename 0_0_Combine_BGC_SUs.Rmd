...
SiteSeries<- dbReadTable(becdb, "tblBEC_SiteSeries_v13_compiled")# %>% filter(Status == "Current") %>% select(BGC_NoSpace, SS_NoSpace, SS_Label)
dbDisconnect(becdb)
...
fwrite(SU_all, "./clean_tabs/All_BGC13_May2025_SU.csv")
# update the BEC
# View output
head(SU_all)
```
