...
db <- "C:/Users/whmacken/Dropbox/NorthThompson_LMH/NorthThompson_FG_draft.accdb"
...
add_cluster_membership <- function(unit.compare, cut.level = .4){
...
groups <- add_cluster_membership(vegsum.pairs, cut.level = .4)
