...
#vegsum = veg_anal.tree; importance = 1; constancy = 60; noiseconstancy = 40; minplots = 0; covadj = .75
create_analysis_vegsum <- function(vegsum, importance = 0, constancy = 0, noiseconstancy = 0, minplots = 0, covadj = 0.5){
