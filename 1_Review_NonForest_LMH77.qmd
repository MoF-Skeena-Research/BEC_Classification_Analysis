...
db <- "D:/BC_Correlation2_Vpro_2023/CoastGuide_NonForested.accdb"
...
beach.su <- dbReadTable(master_su, "BeachPlots_SU")
...
su <- beach.su
su <- su %>%
  filter(!grepl('poor|low|-S|add|nudum|browsed|support|!|Unplaced|X', SiteUnit))  %>% arrange(SiteUnit)
...
author <- "WHMacKenzie"
assoc.choose = "Beach1"
#assoc.list <- su %>% filter(!is.na(SiteUnit)) %>% group_by(SiteUnit) %>% mutate(n=n()) %>% filter(n>2) %>% distinct(SiteUnit) %>% pull(SiteUnit)
...
#su.choose <- c("Bb Abrolat", "Bb Abrocha", "Bb01", "Bb02")
# 
# [1] "Bb01"                   "Bb01.2 Honkpep"         "Bb02"                   "Bb02.1"                 "Bb03"                  
#  [6] "Bb04 Festrub-Fragchi"   "Bb05.1 Ammoare"         "Bb05.2 Ammobre"         "Bb06 Abrolat"           "Bb07 Gaulsha"          
# [11] "Bb08.1 Arctuva"         "Bb08.2 Arctuva-Niphcan" "Bb09 Artecam-Racomit"   "Bb10.1"                 "Bb10.2 Niphcan"        
# [16] "Bb11 Ambrcha"           "Bb12 Glehlit"           "Bb13 Rumefue"           "Bb_Calysol"             "Bb_Festrub"            
# [21] "Bb_Grinsti"             "Bbd01 Poa_mac"          "Br Festrub"             "HwSs-Gaulsha"           "HwSs-Kindpra"         


author = "table1"    
su.choose <- c("Bb01", "Bb01.2 Honkpep", "Bb02", "Bb02.1", "Bb03", "Bb04 Ambrcha","Bb05 Ammoare",  "Bb06 Festrub-Fragchi")
# author = "table2"
# su.choose <- c("Bb07 Gaulsha", "Bb08 Abrolat", "Bb09.1 Arctuva", "Bb09.2 Arctuva-Niphcan", "Bb10 Artecam-Racomit", "Bb11.1", "Bb11.2 Niphcan")
# author = "table3"
# su.choose <- c("Bb12 Glehlit", "Bb13 Rumefue")
...
saveWorkbook(vegsum.wbk, paste0("./vegsum.tables/LMH77_beachassoc_", author, ".xlsx"), overwrite = TRUE)
