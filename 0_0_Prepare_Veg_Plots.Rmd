...
sppmaster <- dbConnect(odbc::odbc(), .connection_string = "Driver={Microsoft Access Driver (*.mdb, *.accdb)}; 
   DBQ=C:/Users/whmacken/OneDrive - Government of BC/BCSpeciesList/SpeciesTaxonomyMaster.accdb;")                       
#DBQ=F:/OneDrive - Government of BC/BCSpeciesList/SpeciesTaxonomyMaster.accdb;")
