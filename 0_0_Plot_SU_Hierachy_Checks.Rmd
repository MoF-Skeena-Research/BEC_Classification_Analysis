...
SU <- SU %>% mutate(bgc = substr(SiteUnit,1,9)) %>% drop_na()
fwrite(SU, "./clean_tabs/CoastGuide_Forest_SU.csv")
...
fwrite(usemorethanone, "./outputs/Coast_SiteUnits_w_lessthan5plots.csv")
```
