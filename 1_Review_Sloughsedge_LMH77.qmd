...
su <- dbReadTable(master_su, "Carex_obnupta_final_SU")
...
create_VGS_table(veg.sum.table, table.name = "Slough sedge")
...
saveWorkbook(vegsum.wbk, "./vegsum.tables/LMH77_draft_sloughsedge_table.xlsx", overwrite = TRUE)
```
