...
veg_anal.tree <- create_su_vegdata(vegdata.tree, su) %>% create_analysis_vegsum (minimportance = 0.5, minconstancy = 60, minplots = 5, covadj = 1)
veg_anal.under <- create_su_vegdata(vegdata.understorey, su) %>% create_analysis_vegsum (minimportance = 0.5, minconstancy = 60, minplots = 5, covadj = .5)
veg_anal.moss <- create_su_vegdata(vegdata.moss, su) %>% create_analysis_vegsum (minimportance = 0.5, minconstancy = 60, minplots = 5, covadj = .1)
