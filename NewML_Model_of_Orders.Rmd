...
treeToTable <- function(SUhier){
  ...
  setnames(tabOut, c("ID","Region","Class","Order","Suborder","Alliance","Suball","Assoc","Subass","Facies", "SiteSeries"))
...
vegDat <- vegDat[!is.na(SiteUnit) & SiteUnit != "",] %>% distinct()
