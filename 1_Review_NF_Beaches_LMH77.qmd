---
title: "Review of LMH 77 Beachlands"
...
su <- dbReadTable(master_su, "Coast_Beach_final_SU")
...
unit.list
 unit.choose <- c("Bb01", "Bb02.1", "Bb02.2", "Bb02!2.1", "Bb02.3", "Bb03", "Bb04", "Bb05")
...
create_VGS_table(veg.sum.table1, table.name = table.name1)
 ...
 unit.choose <- c("Bb!3.1", "Bb06","Bb07.1", "Bb07.2", "Bb08", "Bb08.2", "Bb09", "Bb10", "Bb11") 
 su.choose <- su %>% filter(SiteUnit %in% unit.choose)
table.name2 <- "Beach2"
vegSum <- create_veg_sum_all(vdat = veg.dat2, siteUnits = su.choose, minimportance = 0, minconstancy = 50, noiseconstancy = 25)
##determine order of species by unit
...
saveWorkbook(vegsum.wbk, "./vegsum.tables/LMH77_draft_beach_table.xlsx", overwrite = TRUE)
